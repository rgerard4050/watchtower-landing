...
-- Result: manifest_id is NULL for every manifest ever created through the UI.
--
...
--   after applying (create a manifest via operations/manifest.html and
--   confirm manifest_id is populated with the MFT-###### pattern).
